      ...
      <div className={styles.memberList}>
        ...
        {filteredMembers.length === 0 ? (
          ...
          filteredMembers.map(member => {
            ...
            return (
              <div key={member.id} className={styles.memberCard} onClick={() => router.push(`/members/${member.id}`)}>
                {/* Mobile View Top Row */}
                ...
                <div className={styles.desktopOnly}>
                  <Button variant="ghost" onClick={(e) => { e.stopPropagation(); router.push(`/members/${member.id}`); }}>View</Button>
                </div>
              </div>
            );
          })
